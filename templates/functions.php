<?php
/**
 * WP React Starter Theme functions and definitions
 *
 ...
 */
function wp_react_starter_theme_setup() {
    /*
    ...
    register_nav_menus(
        array(
            'menu-1' => esc_html__('Primary', 'wp-react-starter-theme'),
        )
    );
    ...
    add_theme_support(
        'custom-background',
        apply_filters(
            'wp_react_starter_theme_custom_background_args',
            array(
...
add_action('after_setup_theme', 'wp_react_starter_theme_setup');
 ...
 */
function wp_react_starter_theme_content_width() {
    $GLOBALS['content_width'] = apply_filters('wp_react_starter_theme_content_width', 640);
}
add_action('after_setup_theme', 'wp_react_starter_theme_content_width', 0);
 ...
 */
function wp_react_starter_theme_widgets_init() {
    register_sidebar(
        array(
...
add_action('widgets_init', 'wp_react_starter_theme_widgets_init');

/**
 * Enqueue scripts and styles.
 */
function wp_react_starter_theme_scripts() {
